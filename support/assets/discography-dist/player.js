...
function updateCurrentTime() {
    ...
    audioPlayhead.style.left=(timelineWidth * progressPercentage)+convertRemToPixels(4);
    audioCurrentTime.style.right= (timelineWidth * (1 - progressPercentage))-convertRemToPixels(10);
