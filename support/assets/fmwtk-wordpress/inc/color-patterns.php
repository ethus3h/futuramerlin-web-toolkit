...
function fmwtkwordpress_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'fmwtkwordpress_custom_colors_saturation', 50 ) );
...
.colors-custom .fmwtkwordpress-panel .recent-posts .entry-header .edit-link {
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'fmwtkwordpress_custom_colors_css', $css, $hue, $saturation );
}
