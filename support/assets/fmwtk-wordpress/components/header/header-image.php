...
<div class="custom-header">
	...
	<?php elseif ( fmwtkwordpress_is_frontpage() && has_post_thumbnail() ) :
		// If not, fall back to front page's featured image, only on the front page.
		$post_thumbnail_id = get_post_thumbnail_id( $post->ID );
		$thumbnail_attributes = wp_get_attachment_image_src( $post_thumbnail_id, 'fmwtkwordpress-featured-image' );
		?>
